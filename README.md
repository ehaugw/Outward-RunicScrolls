...
What's the purpose of "Runic Scrolls"?
...
* Download "RunicScrolls.zip".
* Move "RunicScrolls.zip" into the "Outward" game folder.
* Right click "RunicScrolls.zip" and click "Extract Here".
...
* Version 1.0.0 and onwards
  ...
  * Delete the "RunicScrolls" folder.
...
"Runic Scrolls" implements one new item:

**Runic Scroll** Recipe scroll can be bought from any alchemist

* Stacks to 15.
* Equipped in the arrow slot.
* Can be used to cast one [Rune Magic](https://outward.gamepedia.com/Rune_Magic "Rune Magic") without a [Lexicon](https://outward.gamepedia.com/Lexicons "Lexicon"), and one scroll is consumed when doing so.
